...
MODEL_PATH = os.path.join(os.getcwd(), 'models/transformer_persona_and_empathy')           # set clear_dir to False in training.py
...
def start_training(use_gpu):
    ...
    params['ATTEND_ON_OUTPUT'] = True # current Transformer model requires this
